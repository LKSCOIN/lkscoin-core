# Copyright (c) 2022 The Lksc Core developers
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/LKSCOIN/lkscoin-core/pulls/{this_pr_num}')
        ...
        r = requests.get(f'https://github.com/LKSCOIN/lkscoin-core/branches/pre_mergeable/{our_pr_label}...{get_label(this_pr_num)}')
...
def get_label(pr_num):
    return requests.get(f'https://api.github.com/repos/LKSCOIN/lkscoin-core/pulls/{pr_num}').json()['head']['label']
