...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # self.nodes[1].sendrawtransaction(txs[1]['hex']) # disabled, no RBF in Lks
        #self.nodes[0].sendrawtransaction(txs[1]['hex'])  # sending on both nodes is faster than waiting for propagation # disabled, no RBF in Lks
        self.sync_all()
