#!/usr/bin/env python3
# Copyright (c) 2020-2022 The Lksc Core developers
...
class LLMQISMigrationTest(LksTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_lks_test_params(16, 15, [["-whitelist=127.0.0.1"], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []], fast_dip3_enforcement=True)
