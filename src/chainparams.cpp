...
// Used for Platform (not enabled on LKS networks; definition kept for upstream parity)
...
public:
    CMainParams() {
        ...
        // Deployment of Block Reward Reallocation (NOT used by LKSCOIN: GetMasternodePayment
        // is a flat 80%%; deployment kept dormant for upstream code parity)
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].bit = 5;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nStartTime = 1893456000; // Jan 1st, 2030 (dormant)
        ...
        // TODO(GOVERNANCE): confirm activation window with the community before release
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1790812800; // Oct 1st, 2026 - PLACEHOLDER;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nTimeout = 1822348800; // Oct 1st, 2027 - PLACEHOLDER;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nWindowSize = 800;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nThresholdStart = 640; // 80% of 800;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nThresholdMin = 480; // 60% of 800;
...
public:
    CTestNetParams() {
        ...
        consensus.DIP0008Height = 0; // TODO(CONSENSUS): set to actual DIP0008 activation height on LKS testnet
        ...
        // Deployment of DIP0020, DIP0021 and LLMQ_100_67 quorums
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1893456000;
