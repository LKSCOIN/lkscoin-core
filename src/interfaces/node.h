...
//! Interface for the src/evo part of a lks node (lksd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a lks node (lksd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a lks node (lksd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a lks node (lksd process).
...
//! Top-level interface for a lks node (lksd process).
class Node
{
public:
    virtual ~Node() {}
