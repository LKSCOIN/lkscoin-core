...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lks-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lks-tx [options] <hex-tx> [commands]  Update hex-encoded lks transaction\n" +
            "or:     lks-tx [options] -create [commands]   Create hex-encoded lks transaction\n" +
            "\n";
