...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Lks address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Lks address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and lks: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a lks: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Lks command-line options").arg(PACKAGE_NAME));
