...
Platform support
----------------
Support for Lks Platform has been expanded through the addition of a new
...
BLS update
----------
Lksc Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of LksCore. These changes will be made to
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in LksCore v0.16
...
RPC changes
-----------
There are seven new RPC commands which are Lks specific and seven new RPC
...
will be removed in LksCore v0.18. Note that the deprecation of wallet accounts
...
Lks users. Bitcoin changes that do not align with Lks’s product needs, such
