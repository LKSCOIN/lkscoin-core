...
- [`96c041896b`](https://github.com/LKSCOIN/lkscoin-core/commit/96c041896b) feat: add tor entrypoint script for use in lksmate (#4182)
- [`3661f36bbd`](https://github.com/LKSCOIN/lkscoin-core/commit/3661f36bbd) Merge #14416: Fix OSX dmg issue (10.12 to 10.14) (#4177)
- [`4f4bda0557`](https://github.com/LKSCOIN/lkscoin-core/commit/4f4bda0557) depends: Undefine `BLSALLOC_SODIUM` in `bls-lks.mk` (#4176)
- [`575e0a3070`](https://github.com/LKSCOIN/lkscoin-core/commit/575e0a3070) qt: Add `QFont::Normal` as a supported font weight when no other font weights were found (#4175)
- [`ce4a73b790`](https://github.com/LKSCOIN/lkscoin-core/commit/ce4a73b790) rpc: Fix `upgradetohd` help text (#4170)
- [`2fa8ddf160`](https://github.com/LKSCOIN/lkscoin-core/commit/2fa8ddf160) Translations 202105 (add missing) (#4169)
