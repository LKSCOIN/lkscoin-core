...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Lksc Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/LksCore"

touch "/Users/${USER}/Library/Application Support/LksCore/lks.conf"

chmod 600 "/Users/${USER}/Library/Application Support/LksCore/lks.conf"
```

The first time you run lksd, it will start downloading the blockchain. This process could
