...
- [Development guidelines](#development-guidelines)
    - [General Lksc Core](#general-lks-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Lksc Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Lksc Core is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/LKSCOIN/lkscoin-core/blob/master/contrib/valgrind.supp))
...
To profile a running lksd process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep lksd` -- sleep 60
```
...
Lksc Core can be compiled with various "sanitizers" enabled, which add
