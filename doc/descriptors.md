# Support for Output Descriptors in Lksc Core

Since Lksc Core v0.17, there is support for Output Descriptors. This is a
...
existing Lksc Core wallets, a convenience function `combo` is
...
All RPCs in Lksc Core will include the checksum in their output. Only
